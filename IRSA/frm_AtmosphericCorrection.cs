...
namespace IRSA
{
    public partial class frm_AtmosphericCorrection : Form
    {
        public frm_AtmosphericCorrection()
        {
            InitializeComponent();
        }
        ...
        private void btn_OK_Click(object sender, EventArgs e)
        {
            ...
            if (list_B1.Count != 0 && list_B1.Count != 0)
            {
                ...
                try
                {
                    COM_IDL_connectLib.ICOM_IDL_connect oCom = new COM_IDL_connectLib.COM_IDL_connectClass();
