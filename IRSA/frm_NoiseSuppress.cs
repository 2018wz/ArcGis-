...
namespace IRSA
{
    public partial class frm_NoiseSuppress : Form
    {
        public frm_NoiseSuppress()
        {
            InitializeComponent();
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string temp = "noisesuppress20141217,'" + textBox1.Text + "'," + comboBox1.SelectedIndex + ",'" + textBox2.Text + "'";
                ...
                oCom.ExecuteString(".compile '" + Application.StartupPath.ToString() + "\\noisesuppress20141217.pro'");
